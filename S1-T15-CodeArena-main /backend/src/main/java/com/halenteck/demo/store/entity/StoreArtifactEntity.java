...
public class StoreArtifactEntity {
    ...
    // --- storage_path: Database still requires this field, but we store data in DB now ---
    @Column(name = "storage_path", nullable = false)
    @JsonIgnore
    private String storagePath = "db://"; // Placeholder since data is stored in database

    // --- storage_url: Database requires this field ---
    @Column(name = "storage_url", nullable = false)
    @JsonProperty("storageUrl")
    private String storageUrl = "/api/store-artifacts/download/temp"; // Will be set based on id after save
